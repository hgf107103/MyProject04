	...
	<c:forEach items="${tableList}" var="table">
		<tr>
				...
				<c:choose>
    				...
    				<c:otherwise>
    					<td class="tableNumberTd"><c:out value="${table.tableNumber}"></c:out></td>
    					...
    					<td class="costTotalTd"><c:out value="${table.costTotal}원"></c:out></td>
    					<td class="showDetail">
    						<a class="showDetailLink" href="#">보기</a>
    					</td>
    				</c:otherwise>
    			</c:choose>
		</tr>
